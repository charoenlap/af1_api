<?php 
	class ApiController extends Controller {
	    public function index() {
	    	...
	    	$xml = new SimpleXMLElement('<?xml version="1.0"?><res:BookPUResponse  xmlns:res="http://www.af1express.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation= "'.MURL.'index.php?route=api">'.$result_xml.'</res:BookPUResponse>'); 
	    ...
	    public function connote() {
			  ...
			  //   	$html .= '<div>'.$insert_log_data['Place_CompanyName'].'</div>';
					...
					$result_xml_return = array(
						...
						'LabelImage' => array(
							...
							'OutputFullPathPDF' => ''.MURL.'uploads/pdf_label/'.$file_name.'.pdf',
						),
						'Label'	=> array(
							'LabelTemplate'=>''
						)
	    	...
	    	$xml = new SimpleXMLElement('<?xml version="1.0"?><res:ShipmentResponse  xmlns:res="http://www.af1express.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation= "'.MURL.'index.php?route=api/connote">'.$result_xml.'</res:ShipmentResponse>'); 
	    ...
	    public function status() {
	    	...
	    	$result_xml = array_to_xml($result_xml_return, $xml);
	    	$xml = new SimpleXMLElement('<?xml version="1.0"?><req:TrackingResponse  xmlns:req="http://www.af1express.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation= "'.MURL.'index.php?route=api/status">'.$result_xml.'</req:TrackingResponse>'); 
