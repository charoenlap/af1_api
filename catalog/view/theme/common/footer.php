<!-- Footer -->
  ...
  <script src="assets/global/vendor/bootstrap-touchspin/bootstrap-touchspin.min.js"></script>
  ...
  <script src="assets/global/vendor/jquery-strength/password_strength.js"></script>
  ...
  <!-- Scripts -->
  <script src="assets/global/js/Component.min.js"></script>
  <script src="assets/global/js/Plugin.min.js"></script>
  <script src="assets/global/js/Base.min.js"></script>
  <script src="assets/global/js/Config.min.js"></script>
  ...
  <script src="assets/js/Section/GridMenu.min.js"></script>
  <!-- Config -->
  <script src="assets/global/js/config/colors.min.js"></script>
  <script src="assets/js/config/tour.min.js"></script>
  <script>
  ...
  <script src="assets/global/js/Plugin/asscrollable.min.js"></script>
  <script src="assets/global/js/Plugin/slidepanel.min.js"></script>
  <script src="assets/global/js/Plugin/switchery.min.js"></script>

  <script src="assets/global/js/Plugin/jquery-wizard.min.js"></script>
  <script src="assets/global/js/Plugin/matchheight.min.js"></script>
